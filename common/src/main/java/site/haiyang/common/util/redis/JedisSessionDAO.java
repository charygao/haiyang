...
//			jedis.set(UtilsJedis.getBytesKey(sessionKeyPrefix + session.getId()), UtilsJedis.toBytes(session));
//			
//			// 设置超期时间
...
//		} finally {
//			UtilsJedis.returnResource(jedis);
//		}
//	}
//
//	@Override
...
//			jedis = UtilsJedis.getResource();
//			
//			jedis.hdel(UtilsJedis.getBytesKey(sessionKeyPrefix), UtilsJedis.getBytesKey(session.getId().toString()));
//			jedis.del(UtilsJedis.getBytesKey(sessionKeyPrefix + session.getId()));
//
...
//						// Session session = (Session)UtilsJedis.toObject(jedis.get(UtilsJedis.getBytesKey(sessionKeyPrefix + e.getKey())));
...
//				session = (Session)UtilsJedis.toObject(jedis.get(
//						UtilsJedis.getBytesKey(sessionKeyPrefix + sessionId)));
////			}
